...
while true; do
	./$miner -v 2 --sqrl --sqrl-hosts $hosts --sqrl-patience $patience --sqin $sqin --sqid $sqid --sqrl-work-delay $delay $fkvcccmd $jcvcccmd --HWMON 1 --cclk $cclk $autotune -R $stratum1 $stratum2 $apicommand
